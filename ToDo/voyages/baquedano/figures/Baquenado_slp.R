# Make an SLP history figure for the Baquenado
library(grid)
library(chron)
library(lattice)
library(maps)
...
#postscript(file="Baquenado_SLP.eps",paper="a4",family="Helvetica",pointsize=12)
png(file="Baquenado_SLP.png", width=400, height=300, pointsize=12)
