...
my $Din;
open( $Din,
    "/ibackup/cr1/hadobs/OBS/marine/HadISST/norms/HadISST1.1_19611990_pentad_clim.pp"
...
# Subset of the world 20 to 50N, -90 to 10 E
my $Width  = 100;
my $W_off  = 90;
my $Height = 30;
...
for ( my $Day = 0 ; $Day < 73 ; $Day++ ) {
    ...
    my $Dout;
    my $Fname = sprintf "%s/../kml/images/SST_%03d.png", $FindBin::Bin, $Day;
