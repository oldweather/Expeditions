...
pdf(file="../figures/AT.pdf",height=6,width=10,family="Helvetica",pointsize=16)
...
pushViewport(dataViewport(as.numeric(c(sts$Date[1],sts$Date[length(sts$Date)])),c(-12,30)))
