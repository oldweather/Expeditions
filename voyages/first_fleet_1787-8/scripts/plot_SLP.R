# Pressure time-series for the First Fleet
library(grid)
library(chron)
...
png(file="../kml/images/Sirius_SLP.png", width=400, height=300, pointsize=12)
...
grid.yaxis(main=T)
grid.text('Air Pressure (hPa)',x=unit(-3.5,"lines"), rot=90)
