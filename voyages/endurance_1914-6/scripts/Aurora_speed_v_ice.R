...
o<-IMMA::ReadObs('../../../imma/Aurora_1914-16.imma')
...
Twcr<-read.table('Aurora.comparisons',header=FALSE)
Era<-read.table('Aurora.comparisons.ERA20C',header=FALSE)
...
# leave the ice
id<-chron(dates=c("1916/02/01","1916/04/01"),
          times=c("00:00:00","23:59:59"),
          format=c(dates = "y/m/d", times = "h:m:s"))
tics=pretty(id)
ticl=attr(tics,'labels')
