...
Everything we know about past climate change and variability depends on access to historical observations of past weather. For the 70% of the world covered by ocean, that means the `International Comprehensive Ocean-Atmosphere DataSet (ICOADS) <https://icoads.noaa.gov>`_.
